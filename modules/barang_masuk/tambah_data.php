                    ...
                    <div class="card text-center mt-4">
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-3">
                                <div class="p-2">
                                    <h4>Tambah Data Barang Masuk</h4>
                                </div>
                                <div class="p-2 "><a href="barang_masuk.php" class="fa fa-undo" style="text-decoration:none"> Kembali</a></button></div>
                            </div>
                            <hr>
                            ...
                            <form action="tambah_data_aksi.php" method="post">
                                ...
                                $query = mysqli_query($koneksi, "SELECT max(kode_transaksi) as kodeTerbesar FROM i_barangmasuk");
                                    ...
                                    <table class="text-start">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group row p-2 g-col-6">
                                                    <div class="col-xs-3">
                                                        <input class="form-control" type="text" name="tgl_input" required="required" value="<?php echo date("d-m-Y"); ?>" readonly required>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td>
                                                <div class="p-2 g-col-6">
                                                    <select class="form-select" name="kode_supplier" id="kode_supplier" class="select_value" data-placeholder="-- Pilih --" autocomplete="off" required>
                                                        ...
                                                        <?php
                                                        include './../../config/koneksi.php';
                                                        $sql = mysqli_query($koneksi, "SELECT * FROM i_supplier");
