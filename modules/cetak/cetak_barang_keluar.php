...
<section class="p-4" id="main-content">
    ...
    <p class="h2">Rekap Barang Keluar</p>
                ...
                <div class="card text-center mt-4">
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-3">
                            <div class="p-2">
                                <h4>Tabel Data Barang Keluar</h4>
                            </div>
                            <div class="p-2 "><a href="print_keluar.php" class="fa fa-download" style="text-decoration:none"> Cetak Data</a></button></div>
                        </div>
                        <div class="contact-form">
                            <div class="container">
                                <form method="get" action="cetak_barang_keluar.php">
                                    <div class="row">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            if (isset($_GET['filter'])) // Jika user mengisi filter tanggal, maka munculkan tombol untuk reset filter
                                                                echo '<a href="cetak_barang_keluar.php" class="btn btn-default">RESET</a>';
                                                            ?>
                                                        </td>
                                                        <td>
                                ...
                                if (empty($tgl_awal) or empty($tgl_akhir)) { // Cek jika tgl_awal atau tgl_akhir kosong, maka :
                                    ...
                                    $query = "SELECT i_barangkeluar.kode_transaksi, i_barangkeluar.tgl_input, i_plastik.nama_barang, i_barangkeluar.jumlah_keluar, i_barangkeluar.satuan FROM i_barangkeluar 
                                    inner join i_plastik on i_plastik.kode_barang = i_barangkeluar.kode_barang WHERE (i_barangmasuk.tgl_input BETWEEN '" . $tgl_awal . "' AND '" . $tgl_akhir . "') ORDER BY tgl_input DESC";
